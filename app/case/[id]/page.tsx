  ...
  return (
    <main className="space-y-4">
      <section className="card">
        ...
        <Link href={`/chat?caseId=${caseData.id}`} className="mt-3 inline-block rounded-lg bg-blue-600 px-3 py-2 text-sm font-medium text-white">Ask assistant about this case</Link>
      </section>
