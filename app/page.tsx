...
function WorkspacePage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50/40 to-indigo-100/40 p-3 sm:p-4 lg:overflow-hidden lg:p-6">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 rounded-3xl border border-white/70 bg-white/70 p-4 shadow-[0_30px_80px_rgba(15,23,42,0.12)] backdrop-blur sm:p-6 lg:h-[calc(100vh-3rem)]">
        <header className="rounded-2xl border border-teal-100 bg-white p-5 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="max-w-3xl space-y-2">
              ...
              <h1 className="text-3xl font-bold tracking-tight text-slate-900">AMR Steward</h1>
        ...
        <section className="flex min-h-[420px] flex-1 flex-col rounded-2xl border border-slate-200 bg-white shadow-sm lg:min-h-0 lg:overflow-hidden">
          ...
          <div className="p-4 pb-28 sm:p-5 sm:pb-28 lg:h-full lg:overflow-auto">
