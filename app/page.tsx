...
function WorkspacePage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-teal-50/40 to-indigo-100/40 p-4 sm:p-6">
      <div className="mx-auto flex h-[calc(100vh-2rem)] w-full max-w-7xl flex-col gap-4 rounded-3xl border border-white/70 bg-white/70 p-4 shadow-[0_30px_80px_rgba(15,23,42,0.12)] backdrop-blur sm:h-[calc(100vh-3rem)] sm:p-6">
