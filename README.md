...
### Chat not visible?
- The home route redirects to `/new-case`; chat lives at `/chat`.
- You can open it from the top navigation (**Chat**) or from the new-case quick action button.
- Case-grounded mode requires a valid case id (`/chat?caseId=<case-id>`).
